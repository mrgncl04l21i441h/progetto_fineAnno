...
$sql = "SELECT ordini.id AS ordine_id, ordini.id_utente, utenti.nome AS nome_utente, panini.nome AS panino, panini.descrizione AS descrizione_panino, panini.costo AS costo_panino, bevande.nome AS bevanda, bevande.descrizione AS descrizione_bevanda
        FROM ordini
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                ...
                <td><button onclick='delete(" . $row["ordine_id"] . ")'>Delete</button></td> 
            </tr>";
    }
    echo "</table>";
} else {
