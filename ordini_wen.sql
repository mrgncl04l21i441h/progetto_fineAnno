...
--
-- Host: localhost
-- Creato il: Mag 19, 2024 alle 22:20
...
(3, 'Fanta', 2, 'Bottiglia di Fanta 33cl'),
(4, 'Sprite', 2, 'Bottiglia di Sprite 33cl'),
(5, 'Tè freddo', 2, 'Bottiglia di tè freddo al limone 33cl'),
(6, 'Caffè', 1, 'Tazza di caffè espresso');
...
(4, 2, '2024-05-19 20:10:00', '2024-05-19 20:10:50');
...
(3, 'Panino con prosciutto', 5, 'Panino con prosciutto cotto, formaggio, lattuga e maionese'),
(4, 'Panino al pollo', 6, 'Panino con pollo grigliato, lattuga, pomodoro e salsa Caesar'),
(5, 'Panino al tonno', 5, 'Panino con tonno, lattuga, pomodoro e maionese'),
(6, 'Panino vegano', 4, 'Panino con hummus, avocado, lattuga, pomodoro e cetriolo');
...
--
ALTER TABLE `bevande`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Codice univoco per identificare l''entità', AUTO_INCREMENT=7;
...
--
ALTER TABLE `panini_ordinati`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Codice univoco per identificare l''entità', AUTO_INCREMENT=8;
